    ...
    <section id="team" class="team section-bg">
      <div class="container">
        ...
        <div class="section-bg" data-aos="fade-up">
          <h2>Team</h2>
		  <br>
          <p>Our team combines expertise in backend development, creative design, and user experience to deliver excellence in every aspect of our work. We're dedicated professionals, committed to innovation and collaboration to meet and exceed expectations.</p>
        </div>
...
<!-- ======= Testimonials Section ======= -->
    <section id="testimonials" class="testimonials">
      <div class="container">
        ...
        <div class="section-title" data-aos="fade-up">
          <h2>Testimonials</h2>
          <p style="color: black;">Discover the feedback from our valued users, sharing their experiences and satisfaction with our platform.</p>
        </div>
    ...
    <section id="faq" class="faq section-bg">
      <div class="container">
        ...
        <div class="faq-list">
          <ul>
            <li data-aos="fade-up">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" class="collapse" data-bs-target="#faq-list-1">How do I upload my data to the platform?<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-1" class="collapse show" data-bs-parent=".faq-list">
                <p style="color: black;">
                  To upload your data, simply log in to your account, navigate to the "Upload Data" section, and follow the prompts to select and upload your Excel file containing the data.
                </p>
              </div>
            </li>

            <li data-aos="fade-up" data-aos-delay="100">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-2" class="collapsed">Can I export my uploaded data for offline use?<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-2" class="collapse" data-bs-parent=".faq-list">
                <p style="color: black;">
                  Yes, you can export your data by clicking on the "Export" option in the data table you wish to download. Your data will be downloaded as an Excel file for easy offline access.
                </p>
              </div>
            </li>

            <li data-aos="fade-up" data-aos-delay="200">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-3" class="collapsed">Is my data secure on the platform?<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-3" class="collapse" data-bs-parent=".faq-list">
                <p style="color: black;">
                  Absolutely. We take data security seriously and implement measures to safeguard your information. Your data is encrypted during transmission and stored securely on our servers.
                </p>
              </div>
            </li>

            <li data-aos="fade-up" data-aos-delay="300">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-4" class="collapsed">How can I delete a table from my account?<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-4" class="collapse" data-bs-parent=".faq-list">
                <p style="color: black;">
                  To delete a table, navigate to the table you want to remove and click on the "Delete" option. Confirm the deletion, and the table will be permanently removed from your account.
                </p>
              </div>
            </li>

            <li data-aos="fade-up" data-aos-delay="400">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-5" class="collapsed">Is there a limit to the size or number of tables I can upload?<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-5" class="collapse" data-bs-parent=".faq-list">
                <p style="color: black;">
                  While there's currently no specific limit imposed on the size or number of tables you can upload, we recommend optimizing your data and adhering to reasonable usage guidelines to ensure smooth performance for all users.
                </p>
              </div>
            </li>
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-title" data-aos="fade-up">
          <h2>Contact</h2>
          <p style="color: black;">For any inquiries, feedback, or assistance, please don't hesitate to contact us using the following details:</p>
        </div>
        ...
        <div class="row no-gutters justify-content-center" data-aos="fade-up">
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            <iframe style="border:0; width: 100%; height: 270px;" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15465.396897044337!2d120.9155067!3d14.2911306!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397d55f9534769d%3A0x8102047b46464ab7!2sLyceum%20of%20the%20Philippines%20University%20-%20Cavite!5e0!3m2!1sen!2sph!4v1718165935819!5m2!1sen!2sph" frameborder="0" allowfullscreen></iframe>
          </div>
